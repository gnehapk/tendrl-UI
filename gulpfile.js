/* @author Harshal Patil (harshal.patil@emc.com)
 * @description Gulp build script for DPC plugins
 * @version 1.2.0
 */
...
var pluginOpts = pkg.storagePluginProps;
...
gulp.task("copy", function () {
    ...
    filesToCopy = [filters.all, "../package.json", "../config.jst", "!" + filters.jscss];
...
gulp.task("watcher", function (done) {
    ...
    filesToCopy = ["../config.jst", filters.images, filters.html];
